...
//  Soda
//
//  Created by Jerrywang on 2021/9/12.
//
                 ...
                 VStack {
                     HStack {
                        ForEach(0..<data.count, id: \.self) { i in
                            BarChartCell(index: i, normalizedValue: normalizedValue(index: i), barColor: barColor, topText: "\(data[i].value)", bottomText: "今天")
...
let chartDataSet = [
    Point(label: "January 2021", value: 340.32),
    Point(label: "February 2021", value: 250.0),
    Point(label: "March 2021", value: 430.22),
    Point(label: "April 2021", value: 350.0),
    Point(label: "May 2021", value: 450.0),
    Point(label: "June 2021", value: 380.0),
    Point(label: "July 2021", value: 0.0)
 ]
